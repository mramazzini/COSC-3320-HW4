...
('Margherita Pizza', 'A classic pizza.', FALSE, 12.99),
('Iced Latte', 'A chilled iced coffee.', TRUE, 4.50),
('Caesar Salad', 'Crisp romaine lettuce salad.', FALSE, 8.25),
('Smoothie Bowl', 'A blended fruit base topped with granola.', FALSE, 7.99),
...
('Burger & Fries Combo', '1 classic hamburger and 1 portion of fries at a special price.', 6.50),
('Pizza & Soda Combo', '1 Margherita pizza and 1 can of Coke for a discounted price.', 14.49),
('Smoothie & Green Tea Combo', '1 smoothie bowl and 1 green tea to refresh you.', 10.25),
('Latte & Cake Combo', '1 iced latte with 1 classic hamburger for a fulfilling meal.', 9.50),
('Family Pizza Combo', '2 Margherita pizzas and 1 Caesar salad for the whole family.', 30.99),
('Soda & Fries Combo', '2 cans of Coke and 2 portions of fries for a quick snack.', 8.50),
('Ultimate Beverage Combo', '1 can of Coke, 1 can of Sprite, and 1 bottle of water to keep you refreshed.', 4.00),
('Pizza & Salad Combo', '1 Margherita pizza and 1 Caesar salad for a balanced meal.', 21.00),
('Burger Combo', '1 classic hamburger, 1 portion of fries, and 1 can of Fanta.', 9.99),
('Veggie Refresh Combo', '1 Caesar salad, 1 smoothie bowl, and 1 bottle of water.', 17.99),
('Fries & Drink Combo', '3 portions of fries and 3 cans of Coke for a quick meal.', 12.50),
('Breakfast Combo', '1 iced latte, 1 portion of fries, and 1 green tea to kickstart your day.', 11.75);
...
(16, 17, 1); -- Breakfast Combo, 1 green tea
